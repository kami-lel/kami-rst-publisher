...
def copy_rst_recursive3_to(dest_dir):
    ...
    shutil.copytree(rst_recursive1, dest_dir)
    shutil.copytree(rst_recursive2, dest_dir)
    shutil.copytree(rst_recursive3, dest_dir)
...
# BUG
copy_rst_recursive1_to('destdest')